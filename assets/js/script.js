...
* @retun {array} an array of random integers between 0 and `count`-1
*/
...
/**
 * 
 * @returns {array} an array random operators with the length equal to the length of the array of operands
 */
